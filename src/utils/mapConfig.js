...
// Files in /public must respect Vite's base path when the app is deployed
// below the domain root.
export const PUBLIC_BASE_URL = import.meta.env.BASE_URL || '/';
export const publicAsset = (fileName) => `${PUBLIC_BASE_URL.replace(/\/$/, '')}/${fileName}`;
